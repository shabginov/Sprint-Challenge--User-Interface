...
Semantic HTML allows to structure your webpages with meaningful content for browsers

2. Name two big differences between ```display: block;``` and ```display: inline;```.
'display: block' elements take up the whole width of the page unlike inline elements

3. What are the 4 areas of the box model?
Content area, padding, border and margin

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
It'll center elements on cross-axis

5. Explain why git is valuable to a team of developers.
Git allows to track all changes to a project made by an individual or a group of developers
